...
Saran Senior UI/UX untuk Sistem Alamat
  ...
  Ini fitur yang sangat low-friction. Kita bisa lakukan ini:
   ...
   2. Auto-fill: Begitu BottomSheet alamat dibuka, kita bisa panggil API gratis (Nominatim/OSM) untuk otomatis mengisi field Kota, Kecamatan,
      dan Kode Pos.
   3. Manual Input: User hanya perlu melengkapi nama jalan atau nomor rumah saja.

  3. Peta Gratisan? (Saran: Leaflet)
  ...
  1. Buka Home Page.
   2. Klik produk "Royal Canin" (atau produk lainnya). Halamannya pasti muncul sekarang!
   3. Coba masuk ke Checkout -> Tambah Alamat -> Masukkan nomor HP asal -> klik Simpan -> Masukkan OTP 123456.